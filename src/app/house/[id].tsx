...
const AMENITIES = [
    ...
    { icon: 'flash', label: 'Electricity Backup' },
                ...
                <View className="px-5 py-5">
                            ...
                            <View className="w-1/2 mb-4">
                                <View className="flex-row items-center">
                                    ...
                                    <View>
                                        ...
                                        <Text className="text-gray-900 text-base font-semibold">2</Text>
                                    </View>
                                </View>
                            </View>
                            <View className="w-1/2 mb-4">
                                <View className="flex-row items-center">
                                    <View className="w-10 h-10 bg-gray-100 rounded-full items-center justify-center mr-3">
                                        <Ionicons name="water-outline" size={20} color="#0092b8" />
                                    </View>
                                    <View>
                                        <Text className="text-gray-500 text-sm">Bathrooms</Text>
                                        <Text className="text-gray-900 text-base font-semibold">1</Text>
                                    </View>
                                </View>
                            </View>
                            <View className="w-1/2 mb-4">
                                <View className="flex-row items-center">
                                    <View className="w-10 h-10 bg-gray-100 rounded-full items-center justify-center mr-3">
                                        <Ionicons name="resize-outline" size={20} color="#0092b8" />
                                    </View>
                                    <View>
                                        <Text className="text-gray-500 text-sm">Area</Text>
                                        <Text className="text-gray-900 text-base font-semibold">1200 sqft</Text>
                                    </View>
                                </View>
                            </View>
                            <View className="w-1/2 mb-4">
                                <View className="flex-row items-center">
                                    <View className="w-10 h-10 bg-gray-100 rounded-full items-center justify-center mr-3">
                                        <Ionicons name="car-outline" size={20} color="#0092b8" />
                                    </View>
                                    <View>
                                        <Text className="text-gray-500 text-sm">Parking</Text>
                                        <Text className="text-gray-900 text-base font-semibold">Yes</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
                    ...
                    <View>
                        ...
                        <Text className="text-gray-600 text-base leading-6">
                            This beautiful {title.toLowerCase()} is located in the heart of {location}. The property
                            features modern amenities, spacious rooms, and is situated in a quiet and safe
                            neighborhood. Perfect for families or individuals looking for a comfortable living space.
                            {'\n\n'}
                            The house comes with all necessary facilities including electricity backup, water supply,
                            and security services. It's conveniently located near schools, hospitals, shopping centers,
                    ...
                    {/* Amenities */}
                    <View>
                        <Text className="text-xl font-bold text-gray-900 mb-4">Amenities</Text>
                        <View className="flex-row flex-wrap">
                                ...
                                <View key={index} className="w-1/3 mb-4">
                                    <View className="items-center">
                                        <View className="w-12 h-12 bg-gray-100 rounded-full items-center justify-center mb-2">
                                            <Ionicons name={amenity.icon as any} size={20} color="#0092b8" />
                                        </View>
                                        <Text className="text-gray-600 text-sm text-center">{amenity.label}</Text>
                                    </View>
                                </View>
                            ))}
                        </View>
                    ...
                    {/* Availability */}
                    <View className="mb-6">
                        <Text className="text-xl font-bold text-gray-900 mb-3">Availability</Text>
                        <View className="flex-row items-center">
            ...
            <SafeAreaView edges={['bottom']} className="bg-white border-t border-gray-200">
                <View className="px-5 py-4 flex-row items-center justify-between">
                    ...
                    >
                        ...
                        <Text className="text-white font-bold text-base ml-2">Contact Owner</Text>
                    </TouchableOpacity>
                </View>
            </SafeAreaView>
        </View>
